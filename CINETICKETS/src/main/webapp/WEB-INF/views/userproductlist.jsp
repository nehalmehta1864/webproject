...
<center>
									<img id="item-display"
										src="${pageContext.request.contextPath}/resources/${product.pImage}"
					...
					<div class="item-container">
						...
						<div class="col-md-7">
							...
							<input type="hidden" name="prodid" value="${product.id}"
								onkeyup="sum();" /><br> ProductPrice: <input type="text"
								id="txt1" name="prodprice" value="${product.price }" readonly
								onkeyup="sum();" /><br> ProductQuantity:<input type="text"
								id="txt2" name="prodquantity" value="" onkeyup="sum();" />
						...
						<hr>
						 ...
						 <input type="hidden" value="${product.id }" name="cartpid"/>
                                <input type="hidden" value="${product.price}" name="cartprice"/>
                                <input type="hidden" value="${product.pImage}" name="cartImage"/>
                                <input type="hidden" value="${product.name}" name="cartProdName"/>
...
aria-haspopup="true" aria-expanded="false">LOGIN</a></li>
					...
					<!-- <div class="btn-group wishlist">
						<a href="viewcart">
							<button type="button" class="btn btn-success">View Cart
							</button>
						</a>
					</div> -->
				</form>
